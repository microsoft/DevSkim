...
// Setting ComVisible to false makes the types in this assembly not visible to COM components. If you need to
// access a type in this assembly from COM, set the ComVisible attribute to true on that type.
...
//
// You can specify all the values or you can default the Build and Revision Numbers by using the '*' as shown
