...
public class DefaultRulesTests
{
    ...
    ""must-not-match"": [ ""curl --tlsv1.3 https://example.com"" ]
            ...
            [DataRow("DS440016", "test.sh", "curl --tlsv1.1 https://old.example.com; curl --tlsv1.3 https://new.example.com", 1)]
            [DataRow("DS440016", "test.sh", "curl --tlsv1.2 --tlsv1.3 https://example.com", 0)]
