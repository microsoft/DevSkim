...
`+h);let m=N().securityLevel,_;m==="sandbox"&&(_=w("#i"+f));let t=(m==="sandbox"?w(_.nodes()[0].contentDocument.body):w("body")).select("#"+f);t.append("g").append("text").attr("x",100).attr("y",40).attr("class","version").attr("font-size","32px").style("text-anchor","middle").text("v "+x),t.attr("height",100),t.attr("width",400)}catch(m){b.error("Error while rendering info diagram"),b.error(m.message)}},et={draw:tt},ot={parser:B,db:Q,renderer:et,styles:Z};export{ot as diagram};
//# sourceMappingURL=infoDiagram-69ec1a58-EVHWJFTQ.min.js.map
